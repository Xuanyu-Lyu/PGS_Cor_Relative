...
This version uses the set-based merge algorithm (relationship_finder.py) for
...
def main():
    ...
    """
    print(f"\n{'='*70}")
    print("DIRECT ASSORTATIVE MATING - PGS CORRELATION STUDY")
    print(f"{'='*70}")
