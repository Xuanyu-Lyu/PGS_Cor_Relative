...
This script combines the individual condition results from DataGeneratingNN_Combined_03EnvLatentAM.py
into a single training dataset for neural network model training.

Usage:
    python CombineNN_Data_Large_03EnvLatentAM.py [--split] [--test_size 0.2]
...
CONDITION_BASE = Path("/projects/xuly4739/Py_Projects/PGS_Cor_Relative/Data/DataGeneratingNN_Paper/03EnvLatentAM")
OUTPUT_BASE    = Path("/projects/xuly4739/Py_Projects/PGS_Cor_Relative/Data/DataGeneratingNN_Paper")
CONDITION_TAG  = "03EnvLatentAM"
