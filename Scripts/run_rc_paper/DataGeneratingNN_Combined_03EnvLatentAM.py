...
Usage:
    ...
    (Run via SLURM array job - see submit_datagenerating_nn_combined_03EnvLatentAM.sh)
"""
...
PARAM_RANGES = {
    ...
    's11': [0.0, 0.1, 0.2, 0.3, 0.4],
    's22': [0.0, 0.1, 0.2, 0.3, 0.4],
    's12': [0.0, 0.1, 0.2, 0.3, 0.4],
    's21': [0.0, 0.1, 0.2, 0.3, 0.4],
...
def generate_conditions(n_conditions=750, seed=42):
...
def setup_matrices(params):
    ...
    # Environmental correlation matrix (shared environment effects)
    s11 = params['s11']
    s12 = params['s12']
    s21 = params['s21']
    s22 = params['s22']
...
def run_condition(condition, project_base):
    ...
    print(f"# Parameters:")
    print(f"#   vg1={condition['vg1']:.4f}, prop_h2_latent1={condition['prop_h2_latent1']:.4f}, am22={condition['am22']:.4f}")
    print(f"#   vg2={condition['vg2']:.4f}, prop_h2_latent2={condition['prop_h2_latent2']:.4f}")
    print(f"#   rg={condition['rg']:.4f}, re={condition['re']:.4f}")
    print(f"#   f11={condition['f11']:.4f}, f22={condition['f22']:.4f}, f12={condition['f12']:.4f}, f21={condition['f21']:.4f}")
    print(f"#   s11={condition['s11']:.4f}, s22={condition['s22']:.4f}, s12={condition['s12']:.4f}, s21={condition['s21']:.4f}")
