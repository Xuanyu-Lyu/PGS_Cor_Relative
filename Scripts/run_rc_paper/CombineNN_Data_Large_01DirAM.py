...
This script combines the individual condition results from DataGeneratingNN_Combined_01DirAM.py
into a single training dataset for neural network model training.

Usage:
    python CombineNN_Data_Large_01DirAM.py [--split] [--test_size 0.2]
